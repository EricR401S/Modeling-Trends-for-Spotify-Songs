...
df1$danceability <- df1$danceability * 100
df1$speechiness <- df1$speechiness * 100
df1$tempo <- df1$tempo  * 100
...
2. increase by 2.18 times for every thousandth unit increase in the energy predictor. 

3. increase by 10.855 (10,855) times for every thousandth unit increase in the speechiness predictor. 
