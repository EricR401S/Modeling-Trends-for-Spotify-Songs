...
In the analysis of the first research question, which dealt with inferring the significant predictors impacting the popularity of the song, we come to the conclusion that musical attributes like *acousticness*, *danceability*, *energy*, *instrumentalness*, *loudness* and *speechiness* are statistically significant predictors that impact the popularity of the song in teh 201os decade. *Tempo* however, is not a influential variable according to the model analysis. A track that has high levels of acousticness, danceability, loudness and speechiness is likely to have a higher popularity score. While a track with high levels of energy and instrumentalness will have a lower popularity score.
