...
*Popularity (DV1)* is calculated by an algorithm and based on how many times a track has been played and how recent those plays are. This is the response variable that we are interested in this research question 1.

*Explicitness (DV2)* is whether a song contains inappropriate words such as curse words and other words that are deemed unacceptable in a public setting. 1 is the value identifying a song as explicit, while 0 implies that a song is non-explicit. 
