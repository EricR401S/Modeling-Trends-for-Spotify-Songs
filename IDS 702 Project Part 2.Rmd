...
*2. The nature of both the response variable is continuous making it best fit for performing Linear Regression.
*2. From the Exploratory Data Analysis we can observe that there is some relation between the variables with the outcome, which we will probe further in the MLR model analysis. 
